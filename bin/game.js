...
plainText4.addComponentOrReplace(transform41)
...
redBicycle.addComponentOrReplace(transform42)
...
plainText5.addComponentOrReplace(transform43)
...
plainText6.addComponentOrReplace(transform44)
...
imageFromURL6.addComponentOrReplace(transform45)
...
imageFromURL7.addComponentOrReplace(transform46)
...
instagramButtonLink2.addComponentOrReplace(transform47)
...
imageFromURL8.addComponentOrReplace(transform48)
...
plainText7.addComponentOrReplace(transform49)
...
externalLink4.addComponentOrReplace(transform50)
...
roofSimple.addComponentOrReplace(transform51)
...
roundRug.addComponentOrReplace(transform52)
...
imageFromURL9.addComponentOrReplace(transform53)
...
plainText8.addComponentOrReplace(transform54)
...
lamp.addComponentOrReplace(transform55)
...
purpleNeonTube.addComponentOrReplace(transform56)
...
purpleNeonTube2.addComponentOrReplace(transform57)
...
radioCyberpunk.addComponentOrReplace(transform58)
...
purpleNeonTube3.addComponentOrReplace(transform59)
...
purpleNeonTube4.addComponentOrReplace(transform60)
...
ambientSound.addComponentOrReplace(transform61)
...
script4.spawn(plainText4, {"text":"NFT Art for Sale\n(available space)","font":"SF_Heavy","color":"#000000"}, createChannel(channelId, plainText4, channelBus))
