...
import Script8 from "../c5cbd030-54d0-4f28-9158-d27401c691b1/src/item"
...
plainText3.addComponentOrReplace(transform36)
...
largeOrnamentedStoneRail4.addComponentOrReplace(transform37)
...
largeOrnamentedStoneRail5.addComponentOrReplace(transform38)
...
largeOrnamentedStoneRail6.addComponentOrReplace(transform39)
...
redBicycle.addComponentOrReplace(transform40)
...
plainText5.addComponentOrReplace(transform41)
...
plainText6.addComponentOrReplace(transform42)
...
imageFromURL6.addComponentOrReplace(transform43)
...
imageFromURL7.addComponentOrReplace(transform44)
...
instagramButtonLink2.addComponentOrReplace(transform45)
...
imageFromURL8.addComponentOrReplace(transform46)
...
plainText7.addComponentOrReplace(transform47)
...
externalLink4.addComponentOrReplace(transform48)

const roofSimple = new Entity('roofSimple')
engine.addEntity(roofSimple)
roofSimple.setParent(_scene)
const transform49 = new Transform({
  position: new Vector3(14.708329200744629, 0.4237961769104004, 15.469538688659668),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(3.319796562194824, 1.809790849685669, 3.8151960372924805)
})
roofSimple.addComponentOrReplace(transform49)
...
roundRug.addComponentOrReplace(transform50)
...
const transform51 = new Transform({
  position: new Vector3(0.8580684661865234, 5.046233177185059, 8.327934265136719),
  rotation: new Quaternion(2.1723472833404776e-15, -0.7071067094802856, 8.429368136830817e-8, -0.7071068286895752),
  scale: new Vector3(1.667626142501831, 1.5, 0.9999991655349731)
})
imageFromURL9.addComponentOrReplace(transform51)

const plainText8 = new Entity('plainText8')
engine.addEntity(plainText8)
plainText8.setParent(_scene)
const transform52 = new Transform({
  position: new Vector3(0.9614465236663818, 6.759322166442871, 8.323019027709961),
...
plainText8.addComponentOrReplace(transform52)

const lamp = new Entity('lamp')
engine.addEntity(lamp)
lamp.setParent(_scene)
const transform53 = new Transform({
  position: new Vector3(8.01093864440918, 7.787184715270996, 8.000001907348633),
  rotation: new Quaternion(-7.683785927378991e-17, -0.05448140576481819, 6.494688786773395e-9, 0.9985148310661316),
  scale: new Vector3(2.64447283744812, 1.5, 2.8136470317840576)
})
lamp.addComponentOrReplace(transform53)
const gltfShape9 = new GLTFShape("models/HWN20_Lamp_02.glb")
gltfShape9.withCollisions = true
gltfShape9.isPointerBlocker = true
gltfShape9.visible = true
lamp.addComponentOrReplace(gltfShape9)

const purpleNeonTube = new Entity('purpleNeonTube')
engine.addEntity(purpleNeonTube)
purpleNeonTube.setParent(_scene)
const transform54 = new Transform({
  position: new Vector3(4, 3.8720407485961914, 15),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
purpleNeonTube.addComponentOrReplace(transform54)
const gltfShape10 = new GLTFShape("models/NeonLightTube_03/NeonLightTube_03.glb")
gltfShape10.withCollisions = true
gltfShape10.isPointerBlocker = true
gltfShape10.visible = true
purpleNeonTube.addComponentOrReplace(gltfShape10)

const purpleNeonTube2 = new Entity('purpleNeonTube2')
engine.addEntity(purpleNeonTube2)
purpleNeonTube2.setParent(_scene)
purpleNeonTube2.addComponentOrReplace(gltfShape10)
const transform55 = new Transform({
  position: new Vector3(4, 3.8720407485961914, 0.48354244232177734),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
purpleNeonTube2.addComponentOrReplace(transform55)

const radioCyberpunk = new Entity('radioCyberpunk')
engine.addEntity(radioCyberpunk)
radioCyberpunk.setParent(_scene)
const transform56 = new Transform({
  position: new Vector3(14.644227981567383, 0, 12.302767753601074),
  rotation: new Quaternion(1.539415254273621e-15, 0.7071067690849304, -8.429368847373553e-8, -0.7071068286895752),
  scale: new Vector3(1, 1, 1)
})
radioCyberpunk.addComponentOrReplace(transform56)

const purpleNeonTube3 = new Entity('purpleNeonTube3')
engine.addEntity(purpleNeonTube3)
purpleNeonTube3.setParent(_scene)
purpleNeonTube3.addComponentOrReplace(gltfShape10)
const transform57 = new Transform({
  position: new Vector3(12.271636962890625, 3.8720407485961914, 0.6675707101821899),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
purpleNeonTube3.addComponentOrReplace(transform57)

const purpleNeonTube4 = new Entity('purpleNeonTube4')
engine.addEntity(purpleNeonTube4)
purpleNeonTube4.setParent(_scene)
purpleNeonTube4.addComponentOrReplace(gltfShape10)
...
purpleNeonTube4.addComponentOrReplace(transform58)
...
ambientSound.addComponentOrReplace(transform59)
...
nftPictureFrame2.addComponentOrReplace(transform60)

const plainText2 = new Entity('plainText2')
engine.addEntity(plainText2)
plainText2.setParent(_scene)
const transform61 = new Transform({
  position: new Vector3(0.9149041175842285, 3.324985980987549, 3.9761300086975098),
  rotation: new Quaternion(-1.5394153601527394e-15, 0.7071068286895752, -8.429369557916289e-8, 0.7071068286895752),
  scale: new Vector3(1.0000033378601074, 1, 1.0000033378601074)
})
plainText2.addComponentOrReplace(transform61)
...
purpleNeonTube5.addComponentOrReplace(transform63)
...
script7.spawn(radioCyberpunk, {"startOn":false,"volume":0.89,"onClickText":"Radio On/Off","onClick":[{"entityName":"radioCyberpunk","actionId":"toggle","values":{}}],"station":"https://edge.singsingmusic.net/MC2.mp3"}, createChannel(channelId, radioCyberpunk, channelBus))
script8.spawn(ambientSound, {"sound":"Birds","active":true,"loop":true}, createChannel(channelId, ambientSound, channelBus))
script2.spawn(nftPictureFrame2, {"id":"27575328850313694755625005541381465731436274852473056079670032380803546087425","contract":"0x495f947276749ce646f68ac8c248420045cb7b5e","style":"Minimal_Black","color":"#000000","ui":true}, createChannel(channelId, nftPictureFrame2, channelBus))
script4.spawn(plainText2, {"text":"NFTs for Sale","font":"SF","color":"#000000"}, createChannel(channelId, plainText2, channelBus))
script2.spawn(nftPictureFrame3, {"id":"27575328850313694755625005541381465731436274852473056079670032404992801898497","contract":"0x495f947276749ce646f68ac8c248420045cb7b5e","style":"Minimal_Black","color":"#000000","ui":true}, createChannel(channelId, nftPictureFrame3, channelBus))